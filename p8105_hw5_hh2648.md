...
quantities, the figure above shows their distributions. The distribution
of $\beta$ ratio is left-skewed, with a median around -170, while the
adjusted $R^2$ has an approximately normal distribution, with a median
near 0.942.
