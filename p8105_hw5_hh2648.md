...
| Term           |    OR | 95% CI Lower | 95% CI Upper |
|:---------------|------:|-------------:|-------------:|
...
The plot indicates that, in most cities, the OR for solving homicides
involving male victims compared to female victims is less than 1. This
suggests that, holding all other variables constant, homicide cases with
male victims are more likely to remain unsolved than those with female
victims.
...
After performing 5000 bootstrap resamples to estimate the two
quantities, the figure above shows the distributions of their estimates.
The distribution of $\beta$ ratio is left-skewed, with a median around
-170, while the adjusted $R^2$ has an approximately normal distribution,
with a median near 0.942.
...
| Term       | 2.5% Quantile | 97.5% Quantile |
|:-----------|:--------------|:---------------|
...
![](p8105_hw5_hh2648_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
